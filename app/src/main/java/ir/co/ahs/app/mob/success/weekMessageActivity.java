...
public class weekMessageActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar_main_tv_header.setText("داستان هفته");
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(weekMessageActivity.this, "نظر شما با موفقیت ثبت شد", Toast.LENGTH_SHORT).show();
            }
        });
...
//                    struct.strId = object.getString("messageId");
        ...
        dialogPoll = new Dialog(weekMessageActivity.this);
            ...
            public void onClick(View view) {
                ...
                if (isSelected) {
                    if (itemIDs.size() > 0) {
                        ...
                        Toast.makeText(weekMessageActivity.this, "لطفا یک مورد را انتخاب کنید", Toast.LENGTH_SHORT).show();
