package ir.co.ahs.app.mob.success.Helper;
...
public class DataBaseWriter_Product extends SQLiteOpenHelper {
     ...
     * @param context
     */
    public DataBaseWriter_Product(Context context, String dataBaseName, String tableName, String[] fieldNames, String[] fieldTypes) {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table " + TABLE + " (UserID INTEGER PRIMARY KEY AUTOINCREMENT, "
                ...
                + FIELD_NAMES[8] + " " + FIELD_TYPES[8] + ", "
                + FIELD_NAMES[9] + " " + FIELD_TYPES[9] + ", "
                + FIELD_NAMES[10] + " " + FIELD_TYPES[10] + ")");
    }
    ...
    public void sampleMethod(String[] arguments) {
        ...
        values.put(FIELD_NAMES[2], arguments[2]);
        values.put(FIELD_NAMES[3], Integer.parseInt(arguments[3]));
        values.put(FIELD_NAMES[4], Integer.parseInt(arguments[4]));
        values.put(FIELD_NAMES[5], Integer.parseInt(arguments[5]));
        values.put(FIELD_NAMES[6], arguments[6]);
        values.put(FIELD_NAMES[7], arguments[7]);
        values.put(FIELD_NAMES[8], arguments[8]);
        values.put(FIELD_NAMES[9], arguments[9]);
        values.put(FIELD_NAMES[10], arguments[10]);
