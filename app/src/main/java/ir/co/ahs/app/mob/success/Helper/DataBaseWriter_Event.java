...
public class DataBaseWriter_Event extends SQLiteOpenHelper {
     ...
     * @param context
     */
    public DataBaseWriter_Event(Context context, String dataBaseName, String tableName, String[] fieldNames, String[] fieldTypes) {
