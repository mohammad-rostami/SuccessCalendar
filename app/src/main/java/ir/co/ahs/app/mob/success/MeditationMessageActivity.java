...
public class MeditationMessageActivity extends Activity {
...
//                videoView.setVideoURI(Uri.parse(media));
                ...
                play_video.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(MeditationMessageActivity.this, VideoActivity.class);
                        intent.putExtra("media", media);
                        MeditationMessageActivity.this.startActivity(intent);
                    }
                });
...
//Make sure you update Seekbar on UI thread
                MeditationMessageActivity.this.runOnUiThread(new Runnable() {
