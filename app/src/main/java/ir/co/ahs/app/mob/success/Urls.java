...
public class Urls {
    ...
    public static String BASE_URL = "http://webapi-success.ahscoltd.ir/mcapi/";
    ...
    public static String SEND_ACTIVATION_CODE="SendActivationCode";
    public static String HasNewVersionReleased = "HasNewVersionReleased";
    public static String GET_WEEK_MESSAGE_GROUPS = "GetWeekStoryGroup";
    public static String GET_WEEK_SPECIFIC_STORY = "GetWeekSpecificStory";
    public static String GET_LOGIN_TYPE = "GetLoginType";
