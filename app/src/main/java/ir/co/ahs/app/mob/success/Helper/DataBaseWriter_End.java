...
public class DataBaseWriter_End extends SQLiteOpenHelper {
     ...
     * @param context
     */
    public DataBaseWriter_End(Context context, String dataBaseName, String tableName, String[] fieldNames, String[] fieldTypes) {
    ...
    public void sampleMethod(String[] arguments) {
        ...
        values.put(FIELD_NAMES[1], Integer.parseInt(arguments[1]));
