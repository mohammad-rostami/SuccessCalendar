...
public class SuccessStoryListActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SuccessStoryListActivity.this, "نظر شما با موفقیت ثبت شد", Toast.LENGTH_SHORT).show();
            }
        });

        // Dialog Add To Cart

        dialogPoll = new Dialog(SuccessStoryListActivity.this);
            ...
            public void onClick(View view) {
                ...
                if (isSelected) {
                    if (itemIDs.size() > 0) {
                        ...
                        Toast.makeText(SuccessStoryListActivity.this, "لطفا یک مورد را انتخاب کنید", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(TestActivity.this, item.getString("ItemID"), Toast.LENGTH_SHORT).show();
        ...
        adapter_recycler = new Adapter_Recycler(getApplicationContext(), arrayList, new OnItemListener() {
            ...
            public void onCardClick(int position) {
                ...
                Intent intent = new Intent(SuccessStoryListActivity.this,SuccessMessageActivity.class);
                ...
                SuccessStoryListActivity.this.startActivity(intent);
            }
