...
public class Struct {
    ...
    public String strItemTime;
    public Boolean isDone;
    public String strMedia;
    public String strItemMonth;
    public String strItemDay;
}
